...
from app.models import Event, Organizer, User
...
class FunctionalTests(TestCase):
    ...
    def test_signup_successful(self):
        ...
        organizer = Organizer.query.filter_by(
            organizer_email="test@utoronto.ca"
        ).first()
    ...
    def test_duplicate_email(self):
        ...
        print(response.data)
        assert (
            b"Account with this email address already exists!" in response.data
        )
    ...
    def test_incomplete_form(self):
        ...
        )  # Expect an error message for missing confirm_password
    ...
    def test_organizer_appears_webpage(self):
        ...
        assert (
            b'href="/organizer/details/' in response.data
        )  # Check if webpage updated
    ...
    def test_organizer_not_appears_webpage(self):
        ...
        assert (
            b'href="/organizer/details/' not in response.data
        )  # Check if webpage updated (it shouldn't)
    ...
    def test_event_is_created_on_webpage(self):
        ...
        assert (
            b"event-row-component-container event-row-component-root-class-name"
            not in response.data
        )  # Check if no events yet
        ...
        assert (
            b"Test Event" in response.data
        )  # Check if events added in webpage
    ...
    def test_registration(self):
        ...
        self.client.post(f"/register_for_event/{event.id}")
        assert event in current_user.events
        assert current_user in event.users

        self.client.post(f"/unregister_for_event/{event.id}")
